...
function FileSystemPanel({ fsData }: FileSystemPanelProps) {
      ...
      if (typeof value === "string") {
        ...
        return (
          <li key={fullPath} className="select-none">
            <div
              className={`flex items-center py-1 px-2 mx-1 rounded cursor-pointer transition-colors duration-150 ${
                isSelected 
        ...
        return (
          <li key={fullPath} className="select-none">
            ...
            {!isCollapsed && hasChildren && (
              <ul>{renderFS(value, fullPath, depth + 1)}</ul>
            )}
          </li>
        );
      }
  ...
  const demoData: FSData = {
    "src": {
      "components": {
        "Header.tsx": btoa("import React from 'react';\n\nconst Header = () => {\n  return <header>My App</header>;\n};\n\nexport default Header;"),
        "Button.jsx": btoa("const Button = ({ children, onClick }) => {\n  return <button onClick={onClick}>{children}</button>;\n};"),
      },
      "utils": {
        "helpers.js": btoa("export const formatDate = (date) => {\n  return date.toLocaleDateString();\n};"),
        "api.ts": btoa("export const fetchData = async (url: string) => {\n  const response = await fetch(url);\n  return response.json();\n};"),
      },
      "App.tsx": btoa("import React from 'react';\nimport Header from './components/Header';\n\nfunction App() {\n  return (\n    <div className='App'>\n      <Header />\n    </div>\n  );\n}\n\nexport default App;"),
      "index.css": btoa("body {\n  margin: 0;\n  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;\n}"),
    },
    "public": {
      "index.html": btoa("<!DOCTYPE html>\n<html>\n<head>\n  <title>My App</title>\n</head>\n<body>\n  <div id='root'></div>\n</body>\n</html>"),
      "favicon.ico": btoa("favicon-data"),
    },
    "package.json": btoa("{\n  \"name\": \"my-app\",\n  \"version\": \"1.0.0\",\n  \"dependencies\": {\n    \"react\": \"^18.0.0\"\n  }\n}"),
    "README.md": btoa("# My Awesome Project\n\nThis is a demo project built with React.\n\n## Getting Started\n\nnpm install\nnpm start"),
  };
        ...
        <div className="flex-1 overflow-auto">
          <div className="py-2">
            <ul className="space-y-0.5">
              {renderFS(Object.keys(fsData).length > 0 ? fsData : demoData)}
            </ul>
          </div>
        </div>
      </div>
