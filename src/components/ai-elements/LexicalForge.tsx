    ...
    <AnimatePresence>
      <div className="fixed bottom-10 left-1/2 -translate-x-1/2">
        ...
        <motion.div
          ...
          exit={{ y: 10, opacity: 0 }}
          className=" inline-flex items-center gap-2 max-w-[620px] w-[32%] min-w-[300px] bg-[#1f1f1f]/80 text-gray-300 py-2 px-3 rounded-xl border border-[#2d2d2d] shadow-sm hover:shadow-md backdrop-blur-md z-[999]"
        >
          <textarea
            ref={textareaRef}
            value={prompt}
          ...
          <Tooltip content="Run">
            <button
              className=" inline-flex items-center justify-center shrink-0 w-7 h-7 border border-gray-600 rounded-full bg-gray-800/30 hover:bg-gray-700/50 transition disabled:opacity-75 disabled:cursor-progress"
